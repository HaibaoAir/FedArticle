...
% In FL model training, the clients usually consume massive amount of resources, including computing capacity, communication bandwidth and battery charge while training.
...
% 相同的R，超过了，一部分人受困于过小的数据集，另一部分人受困于过老的数据集
% data 那一片也改成pi*
% 变色
